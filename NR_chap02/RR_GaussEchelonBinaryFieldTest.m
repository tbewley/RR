% script <a href="matlab:RR_GaussEchelonTest">RR_GaussEchelonBinaryFieldTest</a>
...
disp('Now testing RR_GaussEchelonBinaryFieldTest on a matrix with m=4, n=5, and r=3.')
