...
K=2043;
g.ls='k-.'; g.omega=logspace(0,3,10000); TestSystem(numG,denG,K,1,g)
...
g.ls='b--'; g.omega=logspace(0,3,100); TestSystem(numG,denG,numD,denD,g)
...
g.ls='r-'; g.K=logspace(-2,2,1000); TestSystem(numG,denG,numD,denD,g)
