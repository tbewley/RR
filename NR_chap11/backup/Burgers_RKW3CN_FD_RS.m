function RR_Burgers_RKW3CN_FD_RS                        % Numerical Renaissance Codebase 1.0
...
% function RR_Burgers_RKW3CN_FD_RS                      % Numerical Renaissance Codebase 1.0
% (... first 12 lines are identical to those in RR_Burgers_RKW3CN_FD.m ...)
for k=1:Tmax/dt                                        
   %%%%%%%%%%%%%%%%%%%%%%%% FIRST RK STEP %%%%%%%%%%%%%%%%%%%%%%%%
...
end % function RR_Burgers_RKW3CN_FD_RS.m
