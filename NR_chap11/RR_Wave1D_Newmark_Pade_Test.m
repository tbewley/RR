% script <a href="matlab:RR_Wave1D_Newmark_Pade_Test">RR_Wave1D_Newmark_Pade_Test</a>
...
% See also RR_Wave1D_ItCN_Pade_Test, RR_Wave1D_ItCN_Pade_Test.
...
for k=1:4;
  ...
  disp(sprintf('Testing RR_Wave1D_ItCN_FD with N=%d, dt=%0.4g',N,dt));
  [q,x]=RR_Wave1D_Newmark_Pade(4,4,1.0,N,dt); grid; if k<4, pause; else, disp(' '), end

  figure(2); plot(x,q); pause(0.001);
end
% end script RR_Wave1D_Newmark_Pade_Test
