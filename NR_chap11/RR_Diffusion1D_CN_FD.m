...
t=0;  x=(0:N)'*dx;  phi=zeros(N+1,1);  RR_PlotXY(x,phi,t,0,L,-1,1); 
...
rhs=zeros(N,1); [rhs,a,b,c]=RR_Thomas(a,b,c,rhs,N); % Determine L & U to reuse during march.
