function StickSlip
% function StickSlip
% Simulates the motion of the elastic conveyer belt system given in Example 17.3 of NR,
% initially at rest and centered, with a unit step input to phi.  SI units.
