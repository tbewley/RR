% script <a href="matlab:RR_FFTdirectTest">RR_FFTdirectTest</a>
% Test <a href="matlab:help FFTdirect">RR_FFTdirect</a> with random real and complex u.
...
for i=1:2
  if i==1, disp('Now testing RR_FFTdirect on a random real vector')
  else, disp('Now testing RR_FFTdirect on a random complex vector'), end
  u=v(:,i); uhat=RR_FFTdirect(u,N,-1); u1=RR_FFTdirect(uhat,N,1);
