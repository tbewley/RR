...
% See also RC_RFFT1inv, RC_RFFT2, RC_RFFT.  Verify with: RC_RFFT1Test.

[uehat,uohat]=RC_RFFT2(u(1:2:N-1),u(2:2:N),N/2);  % Compute FFTs of the even and
