function [v1hat,v2hat,v3hat]=RR_RemoveDivergence(v1hat,v2hat,v3hat,NX,NY,NZ,KX,KY,KZ)
% function [v1hat,v2hat,v3hat]=RR_RemoveDivergence(v1hat,v2hat,v3hat,NX,NY,NZ,KX,KY,KZ)
...
% See also RR_ComputeDivergence.  Verify with: RR_RemoveDivergenceTest.
...
end % function RR_RemoveDivergence
