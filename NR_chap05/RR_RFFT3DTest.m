% script <a href="matlab:RR_RFFT3DTest">RR_RFFT3DTest</a>
% Test <a href="matlab:help RR_RFFT3D">RR_RFFT3D</a> and <a href="matlab:help RR_RFFT3Dinv">RR_RFFT3Dinv</a> on a real 2D field that looks like an egg carton.
...
% See also RR_RFFTtest.

disp('Now testing RR_RFFT3D and RR_RFFT3Dinv on a real 2D field that looks like an egg carton')
...
uhat=RR_RFFT3D(u,NX,NY,NZ); u1=RR_RFFT3Dinv(uhat,NX,NY,NZ); % Transform, and transform back.
