...
% opposed to Algorithm 4.2, this algorithm does not bother reordering the Fourier
...
if g==-1         % FORWARD TRANSFORM (physical space input expected in standard order).
  for stage=1:s  % (This section similar to Alg 4.2, modified as in Fig 4.3.)        
  ...
  for stage=1:s  % (This section as in Alg 4.2.)             
