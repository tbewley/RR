% script <a href="matlab:RR_RFFT2Test">RFFT2Test</a>
% Test <a href="matlab:help RR_RFFT2">RFFT2</a> and <a href="matlab:help RR_RFFT2inv">RR_RFFT2inv</a> with random u and v.
...
% See also RR_RFFT1Test, RR_RFFTTest.

disp('Now testing RR_RFFT2 and RR_RFFT2inv on two random real vectors')
N=16; u=randn(N,1); v=randn(N,1); [uhat,vhat]=RR_RFFT2(u,v,N); [u1,v1]=RR_RFFT2inv(uhat,vhat,N);
