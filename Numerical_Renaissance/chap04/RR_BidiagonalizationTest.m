% script <a href="matlab:RR_BidiagonalizationTest">BidiagonalizationTest</a>
...
[B,U,V]=RR_Bidiagonalization(A,m,n), error=norm(A-U*B*V'), disp(' ')

% end script RR_Bidiagonalization
