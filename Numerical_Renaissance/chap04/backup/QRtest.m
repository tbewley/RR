% script RR_TestQR                                      % Numerical Renaissance Codebase 1.0
...
[R,Q]=RR_QRFastGivensHessenberg(C); nonorthogonality=norm(Q'*Q-eye(size(Q'*Q))), residual=norm(Q*R-C),
...
tic; [R,Q]=RR_QRFastGivensHessenberg(D); toc,
