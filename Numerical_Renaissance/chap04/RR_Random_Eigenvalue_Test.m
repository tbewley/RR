% script <a href="matlab:RR_Random_RR_Eigenvalue_Test">RR_Random_RR_Eigenvalue_Test</a>
...
disp('(appearing on main diagonal of Lambda).  RR_Eigenvectors are (almost always) NOT orthogonal')
fprintf('Press return to continue\n\n'), pause
R_plus_Rprime = R+R',  [S,Lambda] = eig(R_plus_Rprime), S_times_Sprime=S*S'
disp('Notice that R+R'' is symmetric, with real eigenvalues.  RR_Eigenvectors are orthogonal.')
fprintf('Press return to continue\n\n'), pause
R_minus_Rprime = R-R', [S,Lambda] = eig(R_minus_Rprime), S_times_Sprime=S*S'
disp('The matrix R-R'' is skew-symmetric, with pure imaginary eigenvalues.  RR_Eigenvectors are orthogonal.')
fprintf('Press return to continue\n\n'), pause
Rprime_times_R = R'*R, [S,Lambda] = eig(Rprime_times_R), S_times_Sprime=S*S'
disp('This matrix R''*R is symmetric, with real POSITIVE eigenvalues.  RR_Eigenvectors are orthogonal.')
fprintf('Press return to continue\n\n'), pause
...
% end script RR_Random_RR_Eigenvalue_Test
