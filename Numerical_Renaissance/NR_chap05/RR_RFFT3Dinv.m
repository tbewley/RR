...
% See also RFFT3D.  Trial: RFFT3Dtest.

if NZ>1; for I=1:NX/2; for J=1:NY; uhat(I,J,:)=RR_FFTdirect(uhat(I,J,:),NZ,1); end; end; end
for I=1:NX/2; for K=1:NZ;          uhat(I,:,K)=RR_FFTdirect(uhat(I,:,K),NY,1); end; end;
for J=1:NY;   for K=1:NZ;          u   (:,J,K)=RR_RFFTinv  (uhat(:,J,K),NX);   end; end;
