% script <a href="matlab:RR_EigHermitianTest">RR_EigHermitianTest</a>
% Test <a href="matlab:help RR_EigHermitian">RR_EigHermitian</a>, together with <a href="matlab:help RR_ShiftedInversePower">RR_ShiftedInversePower</a>, on a random matrix.
...
disp('Now testing RR_EigHermitian, together with RR_ShiftedInversePower, on a random matrix.')
