function [U,T]=RR_ReorderSchur(U,T,type,e)                % Numerical Renaissance Codebase 1.0
% This function reorders a RR_Schur decomposition such that the stable eigenvalues appear in
...
if m>1                                                     % make new T22 upper triangular
  ...
  [V,temp]=RR_Schur(Q12'*T11*(Q12-Q11*R11*Q22/g));
