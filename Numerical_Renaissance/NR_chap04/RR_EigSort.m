function [lam,S] = RR_EigSort(lam,S)                    % Numerical Renaissance Codebase 1.0
...
[scratch,index]=RR_MergeSort(real(lam),0,length(lam)); lam=lam(index); if (nargout>1), S=S(:,index); end
end % function RR_EigSort.m
