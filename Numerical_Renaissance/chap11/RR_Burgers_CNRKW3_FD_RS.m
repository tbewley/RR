function RR_Burgers_CRCKW3_FD_RS
% function <a href="matlab:RR_Burgers_CRCKW3_FD_RS">RR_Burgers_CRCKW3_FD_RS</a>
...
% See also RR_Burgers_CRCKW3_FD, with 3 registers & 55 flops/timestep (instead of 2 & 57),
...
x=(0:N)*dx;  y=-sin(pi*x/L)-sin(2*pi*x/L)+sin(6*pi*x/L);  RR_PlotXY(x,y,0,0,L,-3,3);
...
% (... initialization identical to that in RR_Burgers_RKW3CN_FD ...)
for k=1:Tmax/dt                                        
   %%%%%%%%%%%%%%%%%%%%%%%% FIRST RK STEP %%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   y(2:N)=RR_ThomasTT(a(1),b(1),c(1),y(2:N)',N-1);                                % ~ 8N
   %%%%%%%%%%%%%%%%%%%%%%%% SECOND RK STEP %%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   z(2:N)=RR_ThomasTT(a(2),b(2),c(2),z(2:N)',N-1);  z(N+1)=0;                     % ~ 8N
   %%%%%%%%%%%%%%%%%%%%%%%% THIRD RK STEP %%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   y(2:N)=RR_ThomasTT(a(3),b(3),c(3),y(2:N)',N-1);                                % ~ 8N
   if (mod(k,PlotInterval)==0) RR_PlotXY(x,y,k*dt,0,L,-3,3); end            
   %%%%%%%%%%%%%%%%%%%%%%%% END OF RK LOOP %%%%%%%%%%%%%%%%%%%%%%%%%%   --------------
end                                                                     % Total: ~ 57N
end % function RR_Burgers_CRCKW3_FD_RS
