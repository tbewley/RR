function [x,t,s]=RR_BDF6iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_BDF6iter(R,x,t,s,p,v,SimPlot)
...
% the 6 most recent values of x on input (from a call to RR_BDF5iter/RR_BDF6iter),
% and the 7 most recent values of x on output (facilitating a call to RR_BDF6iter).
