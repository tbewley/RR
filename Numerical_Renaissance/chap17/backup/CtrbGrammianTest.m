% script <a href="matlab:RR_CtrbGrammianTest">RR_CtrbGrammianTest</a>
...
[P,rc]=RR_CtrbGrammian(A,B,'CT'), e=RR_Eig(P,'h'); RR_Eigenvalues_of_P=e(N:-1:1);
...
[P,rc]=RR_CtrbGrammian(F,G,'DT'), e=RR_Eig(P,'h'); RR_Eigenvalues_of_P=e(N:-1:1);
...
% end script RR_CtrbGrammianTest