function [A,B,C,HankelSingValues]=RR_BalancedForm(A,B,C,MODE)
% function [A,B,C,HankelSingValues]=RR_BalancedForm(A,B,C,[MODE])
...
if nargin==3, MODE='CT'; end, P=RR_CtrbGrammian(A,B,MODE); Q=RR_ObsvGrammian(A,C,MODE);
