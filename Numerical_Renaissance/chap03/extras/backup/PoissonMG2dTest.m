...
% on the diagonal element. By Thomas Bewley, Paolo Luchini, and Anish Karandikar.
...
NX=64; NY=32; XBC=2; YBC=3; N1=2; N2=2; N3=2;           % is applied at various steps.
% ----------------------------------- END OF USER INPUT ----------------------------------
...
for irb=0:1;
  ...
  if verbose>1, if irb==0, lsx='r+'; else, lsx='k+'; end;
    for i=2:xmm; m=2+mod(i+irb+xo+yo,2); n=ymm; for j=m:2:n, plot(i,j,lsx); end; end;
  e=fflush(1); pause(0.01); end;
  EnforceBCs(l);
end;
% end function Smooth
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
