...
for i=0:4 
  ...
  switch mod(i,5) 
    case 0, RR_InsertionSortVerbose;
    case 1, RR_BlockInsertionSortVerbose;
    case 2, RR_QuickSortVerbose(1,n);
    case 3, RR_MergeSortVerbose(1,n);
    case 4, RR_HeapSortVerbose;
  end
