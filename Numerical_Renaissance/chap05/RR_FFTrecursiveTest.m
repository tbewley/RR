% script <a href="matlab:RR_FFTrecursiveTest">RR_FFTrecursiveTest</a> 
% Test <a href="matlab:help RR_FFTrecursive">RR_FFTrecursive</a> with random u.
...
for i=1:2
  if i==1, disp('Now testing RR_FFTrecursive on a random real vector')
  else, disp('Now testing RR_FFTrecursive on a random complex vector'), end
  u=v(:,i); uhat=RR_FFTrecursive(u,N,-1)/N; u1=RR_FFTrecursive(uhat,N,1);
...
% end script RR_FFTrecursiveTest
