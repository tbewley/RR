function [B,A,p] = RR_GaussPP(A,B,n)
% function [B,A,p] = RR_GaussPP(A,B,n)
...
% See also RR_GaussPLU. Trial: RR_GaussPPTest, Example_2_1.
...
% --- THE REMAINDER OF THIS FUNCTION IS IDENTICAL TO RR_Gauss.m ---
% ...
