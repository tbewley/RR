...
clear, n=3  % n=2,3,4,... degree of refinement of each edge (N=2^n intervals)
omega=1     % amount of stretching (0=none, 1=regular stretching, 1.1=overstretching)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=2^n, global RR_VERBOSE; RR_VERBOSE=1; figure(1), clf, figure(2), clf
...
[x,xR]=RR_sphere_gen_orthant(N,omega,1,A,B,C,D); [x,xR]=RR_sphere_gen_orthant(N,omega,1,E,F,G,H);
[x,xR]=RR_sphere_gen_orthant(N,omega,1,A,B,F,E); [x,xR]=RR_sphere_gen_orthant(N,omega,1,B,C,G,F);
[x,xR]=RR_sphere_gen_orthant(N,omega,1,C,D,H,G); [x,xR]=RR_sphere_gen_orthant(N,omega,1,D,A,E,H);
view(57,19)
