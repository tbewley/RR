function [g,xg,yg] = NR_Bezout(a,b)
% function [g,xg,yg] = NR_Bezout(a,b,g,q,n)
...
x=0; y=1; for j=n-1:-1:1                             % Using the q{i} from the GCF call, compute {xg,yg}
  t=x; x=y; y=NR_PolyAdd(t,-NR_PolyConv(q{j},y));    % via the Extended Euclidean algorithm
end, yg=y(find(y,1):end); xg=x(find(x,1):end);
end % function NR_Bezout
