function z=NR_OrthGrid(II,JJ,type,g,c0x,c1x,c0y,c1y)
% function z=NR_OrthGrid(II,JJ,type,g,c0x,c1x,c0y,c1y)
...
x=NR_Stretch1DMesh([0:1/(II-1):1],'p',0,1,c0x,c1x);
y=NR_Stretch1DMesh([0:1/(JJ-1):1],'p',0,1,c0y,c1y);
