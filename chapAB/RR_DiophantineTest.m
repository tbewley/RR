...
f2=RR_PolyProd([1 1],[1 1],[1 3],[1 3],[1 30],[1 30],[1 30],[1 30])
[x2,y2] = RR_Diophantine(a,b,f2)
test2=RR_PolyAdd(RR_PolyProd(a,x2),RR_PolyProd(b,y2)); residual2=norm(RR_PolyAdd(f2,-test2))
...
test3=RR_PolyAdd(RR_PolyProd(a3,x3),RR_PolyProd(b3,y3)); residual=norm(RR_PolyAdd(f3,-test3))
...
test4=RR_PolyAdd(RR_PolyProd(a4,x4),RR_PolyProd(b4,y4)); residual=norm(RR_PolyAdd(f4,-test4))
