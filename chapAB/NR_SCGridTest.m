% script <a href="matlab:NR_SCGridTest">SCGridTest</a>
% Test <a href="matlab:help NR_SCGrid">SCGrid</a> by producing a C-grid, an O-grid, and an H-grid around a NACA0012 airfoil.
...
z=NR_OrthGrid(II,JJ,'Cartesian',g,0,0,0,0);
w=NR_SCGrid(c,n,cin,cout,i1,i2,x,steps,z,II,JJ);
NR_Plot2DMesh(z,1,II,JJ); NR_Plot2DMesh(w,2,II,JJ); hold on; NR_Plot2DMesh(conj(w),2,II,JJ);
print -depsc naca0012_hgrid.eps; pause(0.1);

g.x0=0; g.x1=1.2; g.y1=.3; II=55; JJ=16; steps=15;
z=NR_OrthGrid(II,JJ,'ConfocalParabola',g,0,0,0,0);
w=NR_SCGrid(c,n,cin,cout,i1,i2,x,steps,z,II,JJ);
NR_Plot2DMesh(z,3,II,JJ); NR_Plot2DMesh(w,4,II,JJ); hold on; NR_Plot2DMesh(conj(w),4,II,JJ);
print -depsc naca0012_cgrid.eps; pause(0.1);

g.y1=0.84; II=20; JJ=24; steps=10;
z=NR_OrthGrid(II,JJ,'EllipseHyperbola',g,1,1,0,0); z=(z+1)/2;
w=NR_SCGrid(c,n,cin,cout,i1,i2,x,steps,z,II,JJ);
NR_Plot2DMesh(z,5,II,JJ); NR_Plot2DMesh(w,6,II,JJ); hold on; NR_Plot2DMesh(conj(w),6,II,JJ);
print -depsc naca0012_ogrid.eps;

% end script NR_SCGridTest
