...
clear, close all, syms s V_i V_s C L R R1 R2
...
omega1=10; F_LPF1=RR_tf([omega1],[1 omega1]); figure(1), RR_bode(F_LPF1), pause
...
omega1=10; F_HPF1=RR_tf([1 0],[1 omega1]); figure(2), RR_bode(F_HPF1), pause
...
b  =[ 0; C*s*V_i; V_s; 0];
x=A\b; HPF1biased=simplify(x(4)), pause
