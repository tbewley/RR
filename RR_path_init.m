...
addpath(strcat(RRbase,'/Renaissance_Robotics/chap01'),strcat(RRbase,'/Renaissance_Robotics/chap02'),...
        strcat(RRbase,'/Renaissance_Robotics/chap03'),strcat(RRbase,'/Renaissance_Robotics/chap04'),...
        strcat(RRbase,'/Renaissance_Robotics/chap05'),strcat(RRbase,'/Renaissance_Robotics/chap06'),...
        strcat(RRbase,'/Renaissance_Robotics/chap07'),strcat(RRbase,'/Renaissance_Robotics/chap08'),...
        strcat(RRbase,'/Renaissance_Robotics/chap09'),strcat(RRbase,'/Renaissance_Robotics/chap10'),...
        strcat(RRbase,'/Renaissance_Robotics/chap11'),strcat(RRbase,'/Renaissance_Robotics/chap12'),...
        strcat(RRbase,'/Renaissance_Robotics/chap13'),strcat(RRbase,'/Renaissance_Robotics/chap14'),...
        strcat(RRbase,'/Renaissance_Robotics/chap15'),strcat(RRbase,'/Renaissance_Robotics/chap16'),...
        strcat(RRbase,'/Renaissance_Robotics/chap17'),strcat(RRbase,'/Renaissance_Robotics/chap18'),...
        strcat(RRbase,'/Renaissance_Robotics/chap19'),...
        strcat(RRbase,'/Renaissance_Robotics/chapAA'),strcat(RRbase,'/Renaissance_Robotics/chapAB'),...
        strcat(RRbase,'/Numerical_Renaissance/chap01'),strcat(RRbase,'/Numerical_Renaissance/chap02'),...
        strcat(RRbase,'/Numerical_Renaissance/chap03'),strcat(RRbase,'/Numerical_Renaissance/chap04'),...
        strcat(RRbase,'/Numerical_Renaissance/chap05'),strcat(RRbase,'/Numerical_Renaissance/chap06'),...
        strcat(RRbase,'/Numerical_Renaissance/chap07'),strcat(RRbase,'/Numerical_Renaissance/chap08'),...
        strcat(RRbase,'/Numerical_Renaissance/chap09'),strcat(RRbase,'/Numerical_Renaissance/chap10'),...
        strcat(RRbase,'/Numerical_Renaissance/chap11'),strcat(RRbase,'/Numerical_Renaissance/chap12'),...
