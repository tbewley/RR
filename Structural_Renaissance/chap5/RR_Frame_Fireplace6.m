...
Q=[-2 -2  0  2  2  4  6  6  8;    % Locations of each of the n=6 free nodes
    1 -1  0  1 -1  0 -1  1  0];
U=[ 0  0  0  0  0  0  0  0  0;    % External forces on the n free nodes
   -1  1  0  0  0  0  0  0  0];  
   % m=4 members (columns) 
CT=[ 1 0 0 0 0 0;  % q_1   Connectivity of the pin-jointed frame
     ...
     0 1 1 0 0 0;  % q_4   each node may have 3 or more members attached in
     1 0 0 1 0 0;  % q_5   addition to having a applied external load.
     0 0 1 1 0 0;  % q_6 
     0 0 0 1 1 0;  % q_7 
     0 0 1 0 0 1;  % q_8 
     0 0 0 0 1 1;  % q_9 
     0 0 0 0 0 1;  % p_1
     0 0 0 0 1 0]; % p_2
M =[ 0 0 0 0 0 0]; % External moments on the m members
C=CT';
