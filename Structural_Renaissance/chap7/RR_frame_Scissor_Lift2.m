% script RR_frame_Scissor_Lift2.m
% This script simulates the action of a small scissor lift (a pair of crossed MFMs, and
...
for phi=10:2.5:80
  ...
  S.P=[ 0 P2x;  % Columns denote (x,y) locations of each of the p=2 Pinned supports
        0 P2y];
