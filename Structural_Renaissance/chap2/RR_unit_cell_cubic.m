% script RR_unit_cell_cubic
% draws the unit cell of cubic, BCC, and FCC grids
...
RR_drawsphere_octant(0.5,[0 0 0],[ 1  1  1])
RR_drawsphere_octant(0.5,[1 0 0],[-1  1  1])
RR_drawsphere_octant(0.5,[0 1 0],[ 1 -1  1])
RR_drawsphere_octant(0.5,[1 1 0],[-1 -1  1])
RR_drawsphere_octant(0.5,[0 0 1],[ 1  1 -1])
RR_drawsphere_octant(0.5,[1 0 1],[-1  1 -1])
RR_drawsphere_octant(0.5,[0 1 1],[ 1 -1 -1])
RR_drawsphere_octant(0.5,[1 1 1],[-1 -1 -1])
xlabel('X'); ylabel('Y'); zlabel('Z'); axis equal; view(24,10); axis off

figure(2), clf, hold on, r=sqrt(3)/4
...
RR_drawsphere_octant(r,[1 1 1],[-1 -1 -1])
RR_drawsphere([0.5 0.5 0.5],0,r)
xlabel('X'); ylabel('Y'); zlabel('Z'); axis equal; view(24,10); axis off

figure(3), clf, hold on, r=sqrt(2)/4
RR_drawsphere_octant(r,[0 0 0],[ 1  1  1])
RR_drawsphere_octant(r,[1 0 0],[-1  1  1])
RR_drawsphere_octant(r,[0 1 0],[ 1 -1  1])
RR_drawsphere_octant(r,[1 1 0],[-1 -1  1])
...
figure(4), clf, hold on, r=sqrt(3)/8;
RR_drawsphere_octant(r,[0 0 0],[ 1  1  1])
RR_drawsphere_octant(r,[1 0 0],[-1  1  1])
RR_drawsphere_octant(r,[0 1 0],[ 1 -1  1])
RR_drawsphere_octant(r,[1 1 0],[-1 -1  1])
...
figure(6), clf, hold on, r=1/2; s=sind(60); s2=sind(60)/3; h=sqrt(8/3); N=36
