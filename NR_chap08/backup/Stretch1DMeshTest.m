...
xh=   off+Stretch1DMesh(x,'h',xmin,xmax,1.75);
xc=   off+Stretch1DMesh(x,'c',xmin,xmax)
x00=      Stretch1DMesh(x,'p',xmin,xmax,0,0);
x10=  off+Stretch1DMesh(x,'p',xmin,xmax,1,0);
x20=2*off+Stretch1DMesh(x,'p',xmin,xmax,2,0);
x01=      Stretch1DMesh(x,'p',xmin,xmax,0,1);
x11=  off+Stretch1DMesh(x,'p',xmin,xmax,1,1);
x21=2*off+Stretch1DMesh(x,'p',xmin,xmax,2,1);
x02=      Stretch1DMesh(x,'p',xmin,xmax,0,2);
x12=  off+Stretch1DMesh(x,'p',xmin,xmax,1,2);
x22=2*off+Stretch1DMesh(x,'p',xmin,xmax,2,2);
...
yh1=Stretch1DMesh(xx,'h',0,1,1.2);  yh1d=(yh1(2:end)-yh1(1:end-1))./dx;
yh2=Stretch1DMesh(xx,'h',0,1,1.75); yh2d=(yh2(2:end)-yh2(1:end-1))./dx;
yh3=Stretch1DMesh(xx,'h',0,1,3);    yh3d=(yh3(2:end)-yh3(1:end-1))./dx;
...
yp1=Stretch1DMesh(xx,'p',0,1,0,0);  yp1d=(yp1(2:end)-yp1(1:end-1))./dx;
yp2=Stretch1DMesh(xx,'p',0,1,1,1);  yp2d=(yp2(2:end)-yp2(1:end-1))./dx;
yp3=Stretch1DMesh(xx,'p',0,1,2,2);  yp3d=(yp3(2:end)-yp3(1:end-1))./dx;
...
yc1=Stretch1DMesh(xx,'c',0,1);  yc1d=(yc1(2:end)-yc1(1:end-1))./dx;
