...
while q>1        % Note: diagonal of T_22 block extends from {p,p} to {q,q} elements of T.
  ...
  b=b-mu; [b,c,a,cc,ss]=RC_QRGivensTridiag(a,b,c);      % Shift and calculate QR using Givens
...
end, lam=RC_EigSort(real(b));            % Sort, and remove any error in the imaginary parts.
