...
% function <a href="matlab:RR_WireTest">RR_WireTest</a>
...
% Depends on <a href="matlab:help RR_Eig">RR_Eig</a> and <a href="matlab:help RR_MergeSort">RR_MergeSort</a>.
...
[lam,S]=RR_Eig(A);  [scratch,index]=RR_MergeSort(abs(lam),0,n-1); S=S(:,index); lam=lam(index);
