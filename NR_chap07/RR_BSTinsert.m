function [D,r]=RR_BSTinsert(D,n,r)
% function [D,r]=RR_BSTinsert(D,n,r)
% Insert record n into a RR_BST in D with root r, balancing the affected ancestors as needed.
...
flag=1; while m>0 & flag                  % Scan through ancestors of inserted record,
  gold=D(m,end); [D,m]=RR_BSTrotateLR(D,m);  % rotate if helpful to keep balanced,
