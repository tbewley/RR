function [D,q]=RR_BSTbalance1(D,q)
% function [D,q]=RR_BSTbalance1(D,q)
...
% See also RR_BSTinitialize, RR_BSTinsert, RR_BSTplot, RR_BSTenumerate, RR_BSTsuccessor.
% Verify with RR_BSTtest.
...
if     Dppg>Drg, [D,q]=RR_BSTrotateRight(D,q);
elseif Drrg>Dpg, [D,q]=RR_BSTrotateLeft(D,q); end
end % function RR_BSTbalance1                               
