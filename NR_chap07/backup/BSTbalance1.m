function [D,q]=RC_BSTbalance1(D,q)
% function [D,q]=RC_BSTbalance1(D,q)
...
% See also RC_BSTinitialize, RC_BSTinsert, RC_BSTplot, RC_BSTenumerate, RC_BSTsuccessor.
% Verify with RC_BSTtest.
...
if     Dppg>Drg, [D,q]=RC_BSTrotateRight(D,q);
elseif Drrg>Dpg, [D,q]=RC_BSTrotateLeft(D,q); end
end % function RC_BSTbalance1                               
