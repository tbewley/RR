...
[fx,fy,fxy,Ainv]=RR_BicubicSplineSetup(xd,yd,fd,'parabolic');
BCS=RR_BicubicSpline(x,y,xd,yd,fd,fx,fy,fxy,Ainv); figure(3), mesh(y,x,BCS), view(-11.5,14)

% end script RR_BicubicSplineTest
