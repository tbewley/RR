...
%   A=RR_rand_RR_uint(512), B=RR_rand_RR_uint(400)+1, [Q,R]=A/B, C=(Q*B+R)-A
%
% DEFINITION:
...
classdef (InferiorClasses = {?RR_uint8, ?RR_uint16, ?RR_uint32, ?RR_uint64, ?RR_uint128, ?RR_uint256}) ...
    RR_uint512 < matlab.mixin.CustomDisplay
