function [out,s]=RR_xoshiro128p(n,s)
% function [out,s]=RR_xoshiro128p(n,s)
...
% See https://prng.di.unimi.it/xoshiro128plus.c for Blackman & Vigna's C implementation.
%
...
for i=1:n
  out(i)=bitsrl(RR_sum32(s(1),s(4)),8);                         t=bitsll(s(2),9);
