...
for j=1:4; figure(j), clf, axis equal, axis([0 256 0 256]), hold on
  ...
  name=sprintf('ktuple_clustering%d',j), print('-vector',name,'-depsc'), pause
end, pause
...
for i=1:50, fprintf('%d ',i)
  ...
  switch i
    case {1,2,3,4,5,6,7,20,50}, name=sprintf('k_dim_%02d_256',i), print('-vector',name,'-depsc'), pause
