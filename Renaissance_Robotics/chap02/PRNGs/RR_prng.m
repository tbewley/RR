...
switch generator
  ...
  case {'xoroshiro128**','xoroshiro128++','MWC128XXA32'}
    RR_PRNG_OUTPUT='32bit'; RR_PRNG_x(1,1)=seed32; RR_PRNG_x(2,1)=RR_prod32(a,seed32);
    RR_PRNG_x(3,1)=RR_prod32(a,RR_PRNG_x(2,1));    RR_PRNG_x(4,1)=RR_prod32(a,RR_PRNG_x(3,1));
  otherwise
