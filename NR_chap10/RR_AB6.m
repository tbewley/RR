function [x,t,s]=RR_AB6(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_AB6(R,x,t,s,p,v,SimPlot)
% Simulate x'=f(x), with f implemented in R, using the RR_AB6 method.
...
% which contains the 5 most recent values of f on input (from a prior call to AB5/RR_AB6),
% and the 6 most recent values of f on output (facilitating a subsequent call to RR_AB6).
...
% See also EE, AB2, AB3, AB4, AB5.  Verify with RR_ABtest.
