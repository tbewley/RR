function [x,t,s]=RR_AB5(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_AB5(R,x,t,s,p,v,SimPlot)
% Simulate x'=f(x), with f implmented in R, using the AB5 method.
...
% and the 5 most recent values of f on output (facilitating a subsequent call to AB5/RR_AB6).
...
% See also EE, AB2, AB3, AB4, RR_AB6.  Verify with RR_ABtest.
