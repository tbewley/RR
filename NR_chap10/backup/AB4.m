function [x,t,s]=RR_AB4(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_AB4(R,x,t,s,p,v,SimPlot)
% Simulate x'=f(x), with f implmented in R, using the AB4 method.
...
% See also EE, AB2, AB3, AB5, RR_AB6.  Verify with RR_ABtest.
