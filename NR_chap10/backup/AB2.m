function [x,t,s]=RR_AB2(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_AB2(R,x,t,s,p,v,SimPlot)
% Simulate x'=f(x), with f implmented in R, using the AB2 method.
...
% See also EE, AB3, AB4, AB5, RR_AB6.  Verify with RR_ABtest.
