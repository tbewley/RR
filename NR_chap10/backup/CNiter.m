function [x,t,s]=RR_CNiter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_CNiter(R,x,t,s,p,v,SimPlot)
...
% which contains the 1-2 most recent value(s) of f on input (from, e.g., a call to RR_CNiter),
% and the 2 most recent values of f on output (facilitating a call to RR_CNiter/RR_AM3iter).
...
% See also RR_AM3iter, RR_AM4iter, RR_AM5iter, RR_AM6iter.  Verify with RR_AMtest.
