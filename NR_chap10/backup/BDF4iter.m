function [x,t,s]=RR_BDF4iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_BDF4iter(R,x,t,s,p,v,SimPlot)
...
% the 4 (or more) most recent values of x on input (from a call to RR_BDF3iter/RR_BDF4iter),
% and the 5 most recent values of x on output (facilitating a call to RR_BDF4iter/RR_BDF5iter).
...
% See also RR_IEiter, RR_BDF2iter, RR_BDF3iter, RR_BDF5iter, RR_BDF6iter.  Verify with RR_BDFtest.
