function [x,t,s]=RR_EE(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_EE(R,x,t,s,p,v,SimPlot)
% Simulate x'=f(x), with f implmented in R, using the EE (aka AB1) method.
...
% See also AB2, AB3, AB4, AB5, RR_AB6.  Verify with ODESolverTest.
