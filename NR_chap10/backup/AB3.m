function [x,t,s]=RR_AB3(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_AB3(R,x,t,s,p,v,SimPlot)
% Simulate x'=f(x), with f implmented in R, using the AB3 method.
...
% See also EE, AB2, AB4, AB5, RR_AB6.  Verify with RR_ABtest.
