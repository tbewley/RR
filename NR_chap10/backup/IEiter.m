function [x,t,s]=RC_IEiter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RC_IEiter(R,x,t,s,p,v,SimPlot)
...
% and the 2 most recent values of x on output (facilitating a call to RC_BDF2iter).
...
% See also RC_BDF2iter, RC_BDF3iter, RC_BDF4iter, RC_BDF5iter, RC_BDF6iter.  Verify with RC_BDFtest.
