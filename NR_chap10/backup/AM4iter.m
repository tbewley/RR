function [x,t,s]=RR_AM4iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_AM4iter(R,x,t,s,p,v,SimPlot)
...
% which contains the 3-4 most recent values of f on input (from a call to RR_AM3iter/RR_AM4iter),
% and the 4 most recent values of f on output (facilitating a call to RR_AM4iter/RR_AM5iter).
...
% See also RR_CNiter, RR_AM3iter, RR_AM5iter, RR_AM6iter.  Verify with RR_AMtest.
