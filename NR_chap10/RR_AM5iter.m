function [x,t,s]=RR_AM5iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_AM5iter(R,x,t,s,p,v,SimPlot)
...
% which contains the 4-5 most recent values of f on input (from a call to RR_AM4iter/RR_AM5iter),
% and the 5 most recent values of f on output (facilitating a call to RR_AM5iter/RR_AM6iter).
...
% See also RR_CNiter, RR_AM3iter, RR_AM4iter, RR_AM6iter.  Verify with RR_AMtest.
