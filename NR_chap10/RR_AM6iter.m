function [x,t,s]=RC_AM6iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RC_AM6iter(R,x,t,s,p,v,SimPlot)
% Simulate x'=f(x), with f implemented in R, using the iterative AM6 method with an RC_AB6
...
% which contains the 5 most recent values of f on input (from a call to RC_AM5iter/RC_AM6iter),
% and the 6 most recent values of f on output (facilitating a call to RC_AM6iter).
...
% See also RC_CNiter, RC_AM3iter, RC_AM4iter, RC_AM5iter.  Verify with RC_AMtest.
