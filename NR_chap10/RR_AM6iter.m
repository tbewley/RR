function [x,t,s]=RR_AM6iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=RR_AM6iter(R,x,t,s,p,v,SimPlot)
% Simulate x'=f(x), with f implemented in R, using the iterative AM6 method with an RR_AB6
...
% which contains the 5 most recent values of f on input (from a call to RR_AM5iter/RR_AM6iter),
% and the 6 most recent values of f on output (facilitating a call to RR_AM6iter).
...
% See also RR_CNiter, RR_AM3iter, RR_AM4iter, RR_AM5iter.  Verify with RR_AMtest.
