...
[P,rc]=RC_CtrbGramian(A,B,'CT'), e=RC_Eig(P,'h'); RC_Eigenvalues_of_P=e(N:-1:1);
...
[P,rc]=RC_CtrbGramian(F,G,'DT'), e=RC_Eig(P,'h'); RC_Eigenvalues_of_P=e(N:-1:1);
