function [CM,r] = RR_CtrbMatrix(A,B)
% function [CM,r] = RR_CtrbMatrix(A,B)
...
% Verify with: <a href="matlab:help RR_CtrbMatrixTest">RR_CtrbMatrixTest</a>.

[n,ni]=size(B); CM=[B]; for i=1:n-1, CM=[CM A*CM(:,end-ni+1:end)]; end
if nargout>1; [U,S,V,r] = RR_SVD(CM); end
end % function RR_CtrbMatrix
