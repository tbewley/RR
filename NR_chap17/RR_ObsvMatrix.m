function [OM,r] = RR_ObsvMatrix(A,C)
% function [OM,r] = RR_ObsvMatrix(A,C)
...
% Verify with: <a href="matlab:help RR_ObsvMatrixTest">RR_ObsvMatrixTest</a>.

[no,n]=size(C); OM=[C]; for i=1:n-1, OM=[OM; OM(end-no+1:end,:)*A]; end
if nargout>1; [U,S,V,r]=RR_SVD(OM); end
end % function RR_ObsvMatrix
