function [Q,r] = RR_ObsvGramian(A,C,MODE)
% function [Q,r] = RR_ObsvGramian(A,C,[MODE])
...
% Verify with: <a href="matlab:help RR_ObsvGramianTest">RR_ObsvGramianTest</a>.

if nargin==2, MODE='CT'; end, if MODE=='CT', Q=RR_CALE(A',C'*C); else, Q=RR_DALE(A',C'*C); end
if A==real(A), Q=real(Q); end, if nargout>1; [U,S,V,r]=RR_SVD(Q); end
end % function RR_ObsvGramian
