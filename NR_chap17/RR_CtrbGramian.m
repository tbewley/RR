function [P,r] = RR_CtrbGramian(A,B,MODE)
% function [P,r] = RR_CtrbGramian(A,B,[MODE])
...
% Verify with: <a href="matlab:help RR_CtrbGramianTest">RR_CtrbGramianTest</a>.

if nargin==2, MODE='CT'; end, if MODE=='CT', P=RR_CALE(A,B*B'); else, P=RR_DALE(A,B*B'); end
if A==real(A), P=real(P); end, if nargout>1; [U,S,V,r]=RR_SVD(P); end
end % function RR_CtrbGramian
